...
class VC(object):
    def __init__(self, tgt_sr, config):
        ...
        self.t_pad = self.sr * self.x_pad  # Time padding at the beginning and end of each segment
        self.t_pad_tgt = tgt_sr * self.x_pad  # Target sampling rate multiplied by padding
        self.t_pad2 = self.t_pad * 2  # Double the time padding
        self.t_query = self.sr * self.x_query  # Time around the query cut point for searching
        self.t_center = self.sr * self.x_center  # Position of the query cut point
        self.t_max = self.sr * self.x_max  # Maximum duration threshold for query-free segments
    ...
    def get_f0(self, x, p_len, f0_up_key, f0_method, crepe_hop_length, inp_f0=None):
        ...
        tf0 = self.sr // self.window  # Number of f0 points per second
